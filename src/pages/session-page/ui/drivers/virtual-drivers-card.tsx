...
const renderDriverItem = (_: number, driver: DriverRow) => {
            ...
            >
                <div className="grid grid-cols-[96px_minmax(320px,1fr)_380px] items-center gap-6">
                    ...
                    <div className="min-w-0">
                        ...
                        <Typography variant="h3" className="mt-2 truncate text-lg leading-tight">
                            {getDriverName(driver)}
                        </Typography>

                        <Typography variant="muted" className="mt-1 truncate font-mono">
                    ...
                    <div className="grid grid-cols-[120px_minmax(220px,1fr)] gap-x-6 gap-y-4">
                        ...
                        <StatItem label="Last lap">{formatSeconds(driver.lastLap)}</StatItem>
                        ...
                        <StatItem label="Tyre">
                            ...
                            >
                                {driver.tyreAge != null ? `${driver.tyreAge} laps` : "-"}
                            </Typography>
                        </StatItem>
...
export const VirtualDriversCard = ({ drivers }: VirtualDriversCardProps) => {
    return (
        <Card className="rounded-lg">
            ...
            <CardContent>
                <Virtuoso style={{ height: 520 }} data={drivers} itemContent={renderDriverItem} />
            </CardContent>
        </Card>
    )
}
